...
export function PorTi() {
    return(
        <div className="hero min-h-screen bg-base-200">
            <div className="hero-content flex-col lg:flex-row-reverse">
            <img src="https://www.banorte.com/wps/wcm/connect/banorte/e02522f3-6626-4ee8-a826-cbe7ea1e594a/Banorte_PorTi_410x290.png?MOD=AJPERES&CACHEID=ROOTWORKSPACE.Z18_M202ICC0K05780AILUO1DR2004-e02522f3-6626-4ee8-a826-cbe7ea1e594a-otIkEx." className="max-w-sm rounded-lg shadow-2xl" />
        <div>
